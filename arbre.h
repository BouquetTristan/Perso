 ...
 ****************************************/
t_arbre creer_arbre(int val, char texte[T], t_arbre sag, t_arbre sad, t_arbre pere); /* renvoie l'arbre dont la racine vaut val, avec les sous-arbre sag et sad */
int supprimer_arbre(t_arbre*);		/* supprimer le sous-arbre dont la racine est donnee en parametre  */
t_arbre ajout_gauche(t_arbre, int, char texte[T]); 
t_arbre ajout_droit(t_arbre, int, char texte[T]); 

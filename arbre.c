...
t_arbre creer_arbre(int val, char texte[T], t_arbre sag, t_arbre sad, t_arbre pere){
...
t_arbre ajout_gauche(t_arbre a, int v, char texte[T]){
	if(arbre_vide(a))
		return NULL;
	a->sag = creer_arbre(v, texte, NULL, NULL, a);
	return a->sag;
}

t_arbre ajout_droit(t_arbre a, int v, char texte[T]){

	if(arbre_vide(a))
		return NULL;
	a->sad = creer_arbre(v, texte, NULL, NULL, a);
	return a->sad;
}
